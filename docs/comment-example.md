...
# directory + cache section disabled
...
<details>
  ...
  <h3>Directory impact</h3>
  Pull request changes have no impact on <code>dist</code>.

  <h3>File by file impact</h3>
Pull request changes have no impact on <code>dist</code> files.
