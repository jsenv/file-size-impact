...
export const reportFileSizeImpact = async ({
  ...
  const fileSizeReportModuleUrl = resolveUrl(fileSizeReportModulePath, projectDirectoryUrl)
  ...
  return commentGitHubPullRequestImpact({
    ...
    collectInfo: async ({ execCommandInProjectDirectory }) => {
      ...
      const fileSizeReport = await importOneExportFromFile(fileSizeReportModuleUrl)
