...
const generateDetails = (
  ...
  return `
  ${renderDirectoryImpact(directoryComparison, {
    directoryRelativeUrl,
    pullRequestBase,
    pullRequestHead,
    formatSize,
...
const renderGeneratedByLink = () => {
  return `<sub>Generated by <a href="https://github.com/jsenv/jsenv-github-pull-request-filesize-impact">github pull request filesize impact</a></sub>`
}
